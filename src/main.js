...
const FILMS_COUNT = 5;
const TOP_RATED_AND_MOST_COMMENTED_FILMS_COUNT = 2;
...
const filmsUnusualList = siteMainElement.querySelectorAll(`.films-list--extra`);
